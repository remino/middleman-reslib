...
Then("I should see a figure with image and a caption not wrapped in a paragraph") do
...
Then("I should see a figure with multiple images and a caption not wrapped in a paragraph") do
  expect(page).to have_css("figure", visible: false)
  expect(page).to have_css("figure > img:nth-child(1)", visible: false)
  expect(page).to have_css("figure > img:nth-child(2)", visible: false)
  expect(page).to have_css("figure > figcaption", visible: false)
  expect(page).to_not have_css("p > figure > img", visible: false)
  expect(page).to_not have_css("figure > p", visible: false)
end
...
Then("I should see a figure with an image and a figcaption") do
  expect(page).to have_css("figure", visible: false)
  expect(page).to have_css("figure > img", visible: false)
  expect(page).to have_css("figure > figcaption", visible: false)
end

Then("I should see a figure with a linked image and a figcaption") do
  expect(page).to have_css("figure", visible: false)
  expect(page).to have_css("figure > a > img", visible: false)
  expect(page).to have_css("figure > figcaption", visible: false)
end
